#
# Be sure to run `pod lib lint AssertionNotifier.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AssertionNotifier.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'Elísio Fernandes' => 'elisio.fernandes@farfetch.com' }
